        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction className="bg-orange-100 text-black hover:bg-orange-200 hover:text-black/60 transition-colors duration-200 cursor-pointer">Выйти</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    );
